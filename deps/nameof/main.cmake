...
message(STATUS "Using ${DEPENDENCY_VERSION} of C++ nameof metaprocessing library.")

ExternalProject_Add("${DEPENDENCY}"
	${EP_BASE_LOCATION_ARGS}
	GIT_REPOSITORY "${GITHUB_PREFIX}Neargye/nameof.git"
	...
	CMAKE_CACHE_ARGS
		...
		"-DNAMEOF_OPT_BUILD_EXAMPLES:BOOL=FALSE"
		"-DNAMEOF_OPT_BUILD_TESTS:BOOL=FALSE"
