...
message(STATUS "Using ${DEPENDENCY_VERSION} of deflate library.")

ExternalProject_Add("${DEPENDENCY}"
	${EP_BASE_LOCATION_ARGS}
	GIT_REPOSITORY "${GITHUB_PREFIX}ebiggers/libdeflate.git"
	...
	CMAKE_CACHE_ARGS
		...
		"-DLIBDEFLATE_BUILD_SHARED_LIB:BOOL=${MSVCRT_IS_SHARED}"
