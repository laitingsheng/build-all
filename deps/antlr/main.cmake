...
message(STATUS "Using ${DEPENDENCY_VERSION} of ANTLR.")

ExternalProject_Add("${DEPENDENCY}"
	${EP_BASE_LOCATION_ARGS}
	GIT_REPOSITORY "${GITHUB_PREFIX}antlr/antlr4.git"
	...
	CMAKE_CACHE_ARGS
		...
		"-DWITH_STATIC_CRT:BOOL=${MSVCRT_IS_STATIC}"
		"-DANTLR_BUILD_CPP_TESTS:BOOL=FALSE"
